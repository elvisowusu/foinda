...
export default function CrossBorderPower() {
  return (
    <div className="max-w-7xl py-8 overflow-hidden flex flex-col lg:flex-row items-center h-[32rem] mx-auto lg:mx-[10rem] rounded-3xl
      bg-gradient-to-r from-[#1B2A41] via-[#162238] to-[#0F1A2B]
      backdrop-blur-sm shadow-lg border border-[#F97316]/10 relative"
    >
      {/* Phone Section */}
      <motion.div
      ...
      >
        ...
        <p className="text-[#E0E0E0] leading-relaxed mb-6 max-w-lg">
          Whether your client is in Accra, Lagos, or Nairobi — Foinda ensures your payment lands in seconds. No middlemen, no delays, no guesswork.
        </p>
