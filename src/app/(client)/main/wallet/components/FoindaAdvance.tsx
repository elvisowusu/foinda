...
import { DollarSign, BarChart, FileText, Star } from "lucide-react"; // real icons
...
const features = [
  ...
  {
    icon: <Star size={18} className="text-[#FCD34D] flex-shrink-0" />,
    text: "Transparent dashboard to track repayments",
  },
];

export default function FoindaAdvance() {
  return (
    <div className="max-w-7xl py-12 px-6 lg:px-0 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-[#EDEFF1] rounded-3xl shadow-lg">
      ...
      >
        ...
        <p className="text-[#333333] leading-relaxed mb-6 max-w-lg">
          ...
          verified earnings to offer instant cash advances — no collateral, no
          paperwork.
        </p>
      ...
      {/* Phone Section */}
      <motion.div
        initial={{ opacity: 0, x: 200, rotate: 20 }} // come from right and lean
